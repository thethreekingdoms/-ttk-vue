function getBrowserVersion() {
	var agent = navigator.userAgent.toLowerCase(),
		...
		browser = {
			...
			is360: _mimeAgent("type", "application/vnd.chromium.remoting-viewer"),
...
function accessUrl() {
	...
	if (href.indexOf('127.0.0.1') > -1 || href.indexOf('localhost') > -1) {
		accessUrl = 'http://localhost:1024'
	}
	else if (href.indexOf('dev.') > -1 || href.indexOf('dev-') > -1) {
		accessUrl = 'http://dev-fi.bj.jchl.com:8089'
	}
	else if (href.indexOf('test.') > -1 || href.indexOf('test-') > -1) {
		accessUrl = 'http://test-fi.bj.jchl.com:8089'
	}
	else if (href.indexOf('erpdemo.') > -1) {
		accessUrl = ''
	}
	else if (href.indexOf('erp.') > -1) {
		accessUrl = ''
	}
	return accessUrl
}
