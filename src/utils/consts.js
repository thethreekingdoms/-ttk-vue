...
export const docConsts = {
  ...
  STATUS_VOUCHER_NOT_AUDITED: 1000020001,       //未审核
  STATUS_VOUCHER_AUDITED: 1000020002,           //已审核
  STATUS_VOUCHER_REJECTED: 1000020003,				 //已驳回
  ...
  MOVEROW_UP: 0,	 //向上移动行
  MOVEROW_DOWN: 1,	 //向下移动行

  DIRECTION_DEBIT: 0,	//借方
  DIRECTION_CREDIT: 1,		//贷方
  ...
  //grid的行高
  GRID_ROW_HEIGHT: 50,
  GRID_HEADER_HEIGHT: 73,
  GRID_FOOTER_HEIGHT: 50,

  MAX_ATTACH_COUNT: 9999,  //附件数上限

  ALREADY_FIRST_CERTIFICATE: 70080, //已经是第一张凭证
  ALREADY_LAST_CERTIFICATE: 70081,  //已经是最后一张凭证
  NOT_FOUND_CERTIFICATE: 70037,  //没有找到对应凭证
...
export const otherConsts = {
  ...
  PROVINCE_SHANGHAI: 31,    //省份：31 上海
  PROVINCE_ZHEJIANG: 33,    //省份：33 浙江
  PROVINCE_JIANGXI: 36,    //省份：36 江西
  PROVINCE_GUANGXI: 45,    //省份：45 广西
  PROVINCE_YUNNAN: 53,    //省份：53 云南
  PROVINCE_TIANJIN: 12,    //省份：12 天津
  PROVINCE_CHONGQING: 50,    //省份：50 重庆
  PROVINCE_ANHUI: 34,    //省份：34 安徽

  DOMAIN_LOCALHOST: 'localhost',   //本地
  DOMAIN_LOCALHOST_IP: '127.0.0.1',  //本地
  DOMAIN_DEV_INNER: 'dev.bj.jchl.com:8089',  //dev内网
  DOMAIN_DEV_OUTER: 'dev.bj.jchl.com',  //dev外网
  DOMAIN_DEBUG_INNER: 'debug.bj.jchl.com:8089',  //debug内网
  DOMAIN_DEBUG_OUTER: 'debug.bj.jchl.com',  //debug外网
  DOMAIN_TEST: 'test.bj.jchl.com:8089',  //test内网地址
  DOMAIN_DEMO: 'erpdemo.jchl.com',  //demo地址
  DOMAIN_ONLINE: 'erp.jchl.com',  //线上地址
  DOMAIN_GJ_DEV: 'http://gj.bj.jchl.com:8089',  //着陆页dev地址
  DOMAIN_GJ_DEMO: 'https://gjdemo.jchl.com',  //着陆页demo地址
  DOMAIN_GJ_ONLINE: 'https://gj.jchl.com',  //着陆页线上地址

  API_DOMAIN_DEV: 'http://api.dev.bj.jchl.com:8089/v1',  //api dev地址
  API_DOMAIN_TEST: 'http://api.test.bj.jchl.com:8089/v1',  //api test地址
  API_DOMAIN_DEBUG: 'http://api.bj.jchl.com:8089/v1',  //api debug地址
  API_DOMAIN_DEMO: 'http://apierpdemo.jchl.com/v1',  //api demo地址
  API_DOMAIN_ONLINE: 'http://apierp.jchl.com/v1',  //api online地址

  //jcyy
  JCYY_DEV_DOMAIN: 'http://dev-jcyy.bj.jchl.com:8089',
  JCYY_TEST_DOMAIN: 'http://test-jcyy.bj.jchl.com:8089',
  ...
  //xdz
  XDZ_DEV: 'http://dev-xdz.bj.jchl.com:8089',
  XDZ_TEST: 'http://xdz.bj.jchl.com:8089',
